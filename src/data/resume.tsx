  ...
  work: [
    {
      ...
      description:
        "Led a complete overhaul of performance and user experience by developing a Single Page Application for a real-time data-intensive touchscreen embedded system using React and Redux. Designed new user interfaces that maintained style that users were accustomed to while also improving UX by improving visual feedback and minimizing possible distractions using Figma. Currently developing solutions for the navigation component of the next-generation ground control segment for GPS satellites to ensure accurate real-time values for position and velocity of space vehicles using Java and Python."
    },
    {
      ...
      description:
        "Implemented a full-stack internal bug bounty website, increasing security and streamlining the bug-reporting process by providing a centralized platform for reporting and tracking issues, using MongoDB, Express, React, and NodeJS. Developed a front-end for an intern database, resulting in increased efficiency and ease of use for HR processes, using Angular/HTML/SCSS.",
    },
    {
      ...
      description:
        "Designed web and iOS UI/UX features for slide deck and keynote presentation software, resulting in improved user experience and increased user engagement using Balsamiq Mockups.",
    },
  ],
  education: [
    {
